...
<div>
    ...
    <div class="bg-white shadow rounded-lg p-6 flex flex-col items-start w-full">
        <h3 id="section-title" class="text-lg font-semibold mb-4 text-left w-full">Admin Management</h3>
        <p id="section-desc" class="text-gray-600 text-left w-full">Manage Admin here.</p>
